	...
	<div className="container-fluid d-flex justify-content-center text-center h4 py-4">
            ...
            <div className="row content">
				...
				<div className="container border p-3 rounded shadow border-warning">
					<h1 className="jumbotron-heading">Kihírdetett álláspályázatok</h1>
					<p className="lead text-muted">--Itt tájékozódhat az aktuális álláspályázatokról.--</p>
				</div>
			</section>
      <div className='container-fluid'>
                ...
                <a href='https://drive.google.com/file/d/1TAYAHlyjZP5BBkQV7Yr6MHxKhHxBT71C/view' target='_blank'>
								...
								<img src="data:image/png;base64,"/>
									<div className="ml-2">
										<h6 id='file-text'>Fekete_Matematika - bármely szakos általános iskolai tanár</h6>										
									</div>
								</div>
                </a>
							</li>
          ...
          <div className="col">
						<ul id='list-group' className="list-group mt-5 text-white">
							<li id='files' className="list-group-item d-flex justify-content-between align-content-center">
								<a href='https://drive.google.com/file/d/1VCAim_9irt3kRFv2Phw4yE-rYWg7Nwiz/view' target='_blank'>
								<div className="d-flex flex-row">
								<img src="data:image/png;base64,"/>
									<div className="ml-2">
										<h6 className="mb-0" id='file-text'>Fekete_Digitális kultúra (informatika) - bármely szakos tanár</h6>
									</div>
								</div>
								</a>
							</li>
