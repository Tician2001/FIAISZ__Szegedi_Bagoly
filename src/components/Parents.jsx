...
import '../styles/DataManagementStyles.css';
	...
	return (
		<div className="container-fluid d-flex justify-content-center text-center h4 py-4">
			...
			<div className='container-fluid'>
				...
				<div className='border m-3 p-3 border-warning shadow '>
					<h1 className='text-center'>Hírlevelek</h1>
					<button type="button" className="rounded float-left" data-toggle="modal" data-target=".bd-example-modal-lg"><img className='rounded' src={Club} alt="Szülői klub" height="400" /></button>
...
<div className="modal fade bd-example-modal-lg"  role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div className="modal-dialog modal-lg">
	...
	<img className='rounded border' src={Club} alt="Szülői klub" height="700" width="500" />
    </div>
  </div>
</div>
				</div>
